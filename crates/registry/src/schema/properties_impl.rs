...
impl EnumImpl for Property {
    fn parse(value: &str) -> Option<Self> {
        hashify::tiny_map! {
            ...
            b"xapsDelay" => Property::XapsDelay,
            b"xapsCheckInterval" => Property::XapsCheckInterval,
            b"xapsCertificateFilePem" => Property::XapsCertificateFilePem,
            b"xapsCertificateFilePemKey" => Property::XapsCertificateFilePemKey,
            b"xapsCertificateFileP12" => Property::XapsCertificateFileP12,
            b"xapsCertificateFileP12Password" => Property::XapsCertificateFileP12Password,
    ...
    fn as_str(&self) -> &'static str {
        match self {
            ...
            Property::XapsCheckInterval => "xapsCheckInterval",
            Property::XapsCertificateFilePem => "xapsCertificateFilePem",
            Property::XapsCertificateFilePemKey => "xapsCertificateFilePemKey",
            Property::XapsCertificateFileP12 => "xapsCertificateFileP12",
            Property::XapsCertificateFileP12Password => "xapsCertificateFileP12Password",
            Property::Zone => "zone",
    ...
    fn from_id(id: u16) -> Option<Self> {
        match id {
            ...
            930 => Some(Property::XapsDelay),
            931 => Some(Property::XapsCheckInterval),
            932 => Some(Property::XapsCertificateFilePem),
            933 => Some(Property::XapsCertificateFilePemKey),
            934 => Some(Property::XapsCertificateFileP12),
            935 => Some(Property::XapsCertificateFileP12Password),
